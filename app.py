...
def main():
    ...
    # Load stopwords and model/vectorizer
    ...
    col1, col2 = st.columns([1, 2])  # Input / output layout
        ...
        with col2:
            if fetch_btn:
                if username.strip() == "":
                    ...
                    tweets = fetch_tweets(username_clean, num_tweets)
                    if tweets:
                        ...
                        st.error("No tweets found or user may be private/nonexistent.")
