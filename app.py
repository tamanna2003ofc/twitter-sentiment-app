...
def initialize_scraper():
    # Initialize without instance to avoid TypeError
        ...
        with col2:
            if fetch_btn:
                if username.strip() == "":
                    ...
                    try:
                        # Specify working Nitter instance during fetch
                        tweets_data = scraper.get_tweets(username_clean, mode='user', number=num_tweets, instance="nitter.net")
                    ...
                    if tweets_data and 'tweets' in tweets_data and len(tweets_data['tweets']) > 0:
                        ...
                        st.error("No tweets found or the Nitter instance is temporarily unavailable.")
